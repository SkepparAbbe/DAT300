...
epsilon=2000;minPts=100;numberOfHashTables=5;numberOfHyperPlanesPerTable=5;files=" -f ../../datasets/household/clean_normalized_household.txt -b ../../datasets/household/clean_normalized_household.idx"
...
#################################################################################################
epsilon=2000;minPts=100;numberOfHashTables=10;numberOfHyperPlanesPerTable=5;files=" -f ../../datasets/household/clean_normalized_household.txt -b ../../datasets/household/clean_normalized_household.idx"
