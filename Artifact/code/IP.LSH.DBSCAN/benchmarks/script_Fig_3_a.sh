...
epsilon=1500;minPts=100;numberOfHashTables=5;numberOfHyperPlanesPerTable=5;files=" -f /data/cleaned_day_0.txt"
...
mv memory_usage.log ./memory_usage_L_${numberOfHashTables}_M_${numberOfHyperPlanesPerTable}.log
###################################################
epsilon=1500;minPts=100;numberOfHashTables=20;numberOfHyperPlanesPerTable=5;files=" -f /data/cleaned_day_0.txt"
